...
const leagues = [
  {id: 1, name: 'SUPER LIGA ARGENTINA', dateMatch: '5', amount: 8, position: 1, img: 'https://viapais.com.ar/media/cache/resolve/small/https://viapais.com.ar/files/2018/05/20180505010321_32587604_0_body.jpg', dateMatches: [
    {
      name: '1',
      matches: [
  ...
  {id: 2, name: 'UEFA CHAMPIONS LEAGUE', dateMatch: 'Clasificacion - Etapa 1', amount: 12, position: 1, img: 'https://i.ytimg.com/vi/t0r0KJe4L6U/maxresdefault.jpg', dateMatches: [
    {
      name: '1',
      matches: [
        { schedule: { dayOfWeek: null, date: '10/8', hour: null }, local: { name: 'Vélez', goals: 2 }, visitant: { name: 'Newell\'s', goals: 0 }, state: 'Finished' },
  ...
  {id: 3, name: 'COPA ARGENTINA', dateMatch: '16avos', amount: 5, positon: 3, img: 'https://www.infobae.com/new-resizer/qE8J5Kv0baDbSObVIG7PglvTfmA=/600x0/filters:quality(100)/s3.amazonaws.com/arc-wordpress-client-uploads/infobae-wp/wp-content/uploads/2018/06/11173736/Copa-Argentina-2.jpg', dateMatches: [
    {
      name: '1',
      matches: [
        { schedule: { dayOfWeek: null, date: '10/8', hour: null }, local: { name: 'Vélez', goals: 2 }, visitant: { name: 'Newell\'s', goals: 0 }, state: 'Finished' },
  ...
  {id: 4, name: 'COPA LIBERTADORES', dateMatch: '4tos', amount: 250, position: 1, img: 'https://prod.media.libero.pe/660x378/libero/imagen/2018/05/21/noticia-copa-libertadores-2018.jpg', dateMatches: [
    {
      name: '1',
      matches: [
        { schedule: { dayOfWeek: null, date: '10/8', hour: null }, local: { name: 'Vélez', goals: 2 }, visitant: { name: 'Newell\'s', goals: 0 }, state: 'Finished' },
